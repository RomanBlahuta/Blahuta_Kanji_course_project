...
class KanaSet:
    ...
    Is used for working with KanaChar objects and their storage'''
    ...
    def sameConsonant(self, cons):
        '''
        Returns list of all KanaChar objects with corresponding consonant.
        :param cons: str
        :return: list
        '''
        result = list()
    ...
    def sameVowel(self, vow):
        '''
        Returns list of all KanaChar objects with corresponding vowel.
        :param vow: str
        :return: list
        '''
        result = list()
    ...
    def soundByChar(self, chr):
        '''
        Returns a sound str value of KanaChar with
...
def kanaSetUp(file, kanabool):
    ...
    Works with json files structured like
